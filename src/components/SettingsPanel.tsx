...
const MODELS = [
  { id: 'claude-opus-4-6', label: 'Opus 4.6', desc: 'Most powerful — CTO-level reasoning', color: 'bg-purple' },
  { id: 'claude-sonnet-4-20250514', label: 'Sonnet 4', desc: 'Balanced speed & quality', color: 'bg-accent' },
  { id: 'claude-haiku-4-5-20251001', label: 'Haiku 4.5', desc: 'Fastest — triage & simple tasks', color: 'bg-green' },
  { id: 'gpt-5.3-codex', label: 'GPT 5.3 Codex', desc: 'OpenAI — optimized for code generation', color: 'bg-yellow' },
];
